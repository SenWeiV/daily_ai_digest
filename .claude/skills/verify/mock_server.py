...
async def fake_github(time_range="daily"):
    ...
    return [
        GitHubDigestItem(
            repo_name="research/new-vision-agent",
            repo_url="https://github.com/research/new-vision-agent",
            stars=42,
            description="A recent vision-language agent benchmark implementation.",
            summary="A reproducible benchmark for vision-language agents.",
            research_topics=["multimodal", "agentic"],
            quality_evidence=["substantive_readme", "implementation", "artifacts_or_experiments"],
            quality_grade="A",
        ),
        GitHubDigestItem(
